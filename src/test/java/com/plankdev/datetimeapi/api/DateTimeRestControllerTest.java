...
public class DateTimeRestControllerTest extends RestControllerTestBase {
    ...
    public void testFindWeeksWithStartAndEndDateWorks() throws Exception {
        ...
        final String FORMAT_EXPECTED = "day"; //TODO: fix parameter to generic one

        LocalDateTime startDateTime = LocalDateTime.of(2018, 9,5,5, 30);
        LocalDateTime endDateTime = LocalDateTime.of(2018, 10, 10, 5, 30);

        String queryURL = ENDPOINT_BASE + "/weeks?" + START_DATE + startDateTime.toString() + "&" + END_DATE + endDateTime.toString();
    ...
    public void testFindWeeksWithFormatParameterWorks() throws Exception {
        ...
        String queryURL = ENDPOINT_BASE + "/weeks?" + START_DATE + startDateTime.toString() + "&" + END_DATE + endDateTime.toString() + "&" + FORMAT + FORMAT_EXPECTED;
